...
cat /etc/akubudakgerik/xray-mini-utils/socks-backup.json | jq '.inbounds[0].settings.accounts += [{"user": "'${Username}'","pass": "'${Username}'" }]' > /etc/xray-mini/socks.json;
...
mkdir -p /etc/akubudakgerik/socks/;
mkdir -p /etc/akubudakgerik/socks/${Username};
rm -f /etc/akubudakgerik/socks/${Username}/config.log;

# // Success
sleep 1;
clear;
echo -e "Your Premium Socks4/5 Proxy" | tee -a /etc/akubudakgerik/socks/${Username}/config.log;
echo -e "===============================" | tee -a /etc/akubudakgerik/socks/${Username}/config.log;
echo -e " IP          = ${IP_NYA}" | tee -a /etc/akubudakgerik/socks/${Username}/config.log;
echo -e " Address     = ${domain}" | tee -a /etc/akubudakgerik/socks/${Username}/config.log;
echo -e " Port        = ${port}" | tee -a /etc/akubudakgerik/socks/${Username}/config.log;
echo -e " User        = ${Username}" | tee -a /etc/akubudakgerik/socks/${Username}/config.log;
echo -e " Password    = ${Username}" | tee -a /etc/akubudakgerik/socks/${Username}/config.log;
echo -e "===============================" | tee -a /etc/akubudakgerik/socks/${Username}/config.log;
echo -e " SOCKS4/5 CONFIG LINK" | tee -a /etc/akubudakgerik/socks/${Username}/config.log;
echo -e " ${tmp1}" | tee -a /etc/akubudakgerik/socks/${Username}/config.log;
echo -e "===============================" | tee -a /etc/akubudakgerik/socks/${Username}/config.log;
echo -e " Created     = ${hariini}" | tee -a /etc/akubudakgerik/socks/${Username}/config.log;
echo -e " Expired     = ${exp}";
echo -e "===============================";