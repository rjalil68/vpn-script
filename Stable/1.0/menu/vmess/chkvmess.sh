...
echo -n > /etc/akubudakgerik/cache/vmess_temp.txt;
echo -n > /etc/akubudakgerik/cache/vmess_temp2.txt;
...
if [[ "$jum" = "$ip" ]]; then
echo "$jum" >> /etc/akubudakgerik/cache/vmess_temp.txt;
else
echo "$ip" >> /etc/akubudakgerik/cache/vmess_temp2.txt;
fi
jum2=$(cat /etc/akubudakgerik/cache/vmess_temp.txt);
sed -i "/$jum2/d" /etc/akubudakgerik/cache/vmess_temp2.txt > /dev/null 2>&1;
done
jum=$(cat /etc/akubudakgerik/cache/vmess_temp.txt);
if [[ -z "$jum" ]]; then
echo > /dev/null;
else
jum2=$(cat /etc/akubudakgerik/cache/vmess_temp.txt | nl);
...
echo "=============================================";
echo -n > /etc/akubudakgerik/cache/vmess_temp3.txt;
data=(`cat /etc/xray-mini/client.conf | grep '^Vmess' | cut -d " " -f 2`);
for akun in "${data[@]}"
do
if [[ -z "$akun" ]]; then
...
echo "=============================================";
oth=$(cat /etc/akubudakgerik/cache/vmess_temp2.txt | sort | uniq | nl )
echo "GRPC IP : All User IP";
echo "$oth";
echo "=============================================";
echo "";
rm -rf /etc/akubudakgerik/cache/vmess_temp2.txt;
rm -rf /etc/akubudakgerik/cache/vmess_temp.txt;
rm -rf /etc/akubudakgerik/cache/vmess_temp3.txt;