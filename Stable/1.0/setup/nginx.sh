...
./configure --prefix=/etc/akubudakgerik/webserver/ \
...
wget -q -O /lib/systemd/system/nginx.service "https://rjalil68/vpn-script/Resource/Service/nginx_service";
systemctl stop nginx;
rm -rf /etc/nginx/sites-*;
mkdir -p /etc/nginx/conf.d/;
wget -q -O /etc/nginx/nginx.conf "https://rjalil68/vpn-script/Resource/Config/nginx_conf";
wget -q -O /etc/nginx/conf.d/akubudakgerik.conf "https://rjalil68/vpn-script/Resource/Config/akubudakgerik_conf";
mkdir -p /etc/akubudakgerik/webserver/;
wget -q -O /etc/akubudakgerik/webserver/index.html "https://rjalil68/vpn-script/Resource/Config/index.file";
sudo chown -R www-data:www-data /etc/akubudakgerik/webserver/;
sudo chmod 755 /etc/akubudakgerik/webserver/;
