...
wget -q -O /etc/stunnel/stunnel.conf "https://rjalil68/vpn-script/Resource/Config/stunnel_conf";
wget -q -O /etc/stunnel/stunnel.pem "https://rjalil68/vpn-script/Data/stunnel_cert";
